    ...
    <section className="bg-transparent">
      <div className="bg-transparent py-24">
        <div className="mx-auto w-full max-w-5xl px-6">
          <div>
            <h2 className="text-[#4166F5] text-[28px] font-bold leading-[1.2] font-manrope">Seamless Order & Customer Management</h2>
            <p className="text-gray-600 mb-12 mt-4 text-balance text-lg font-inter">
          ...
          <div className="border-gray-200 relative mt-16 grid gap-12 border-b pb-12 [--radius:1rem] md:grid-cols-2">
            <div>
              <h3 className="text-[#4166F5] text-[22px] font-semibold font-manrope">Broadcast Campaigns</h3>
              <p className="text-gray-600 my-4 text-base font-inter">
            ...
            <div>
              <h3 className="text-[#4166F5] text-[22px] font-semibold font-manrope">Visual Automation Builder</h3>
              <p className="text-gray-600 my-4 text-base font-inter">
          ...
          <blockquote className="before:bg-[#4166F5] relative mt-12 max-w-xl pl-6 before:absolute before:inset-y-0 before:left-0 before:w-1 before:rounded-full">
            ...
            <footer className="mt-4 flex items-center gap-2">
              ...
              <span className="text-gray-500 font-inter text-sm">Store Owner</span>
            </footer>
          </blockquote>
        </div>
      </div>
