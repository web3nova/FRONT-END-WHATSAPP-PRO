      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-gray-700 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">For questions about this policy, contact us on WhatsApp: <a href="https://wa.me/2348029545794" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">+234 802 954 5794</a></p>
          </section>
          ...
          <section>
            ...
            <p>You have the right to access, correct, or delete your personal data at any time. To exercise these rights, contact us on WhatsApp at <a href="https://wa.me/2348029545794" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">+234 802 954 5794</a>.</p>
          </section>
